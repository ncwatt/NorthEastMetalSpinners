    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-12">
                ...
                <h1>Contact Us</h1>
                <p class="lead d-lg-none <?php echo(isset($postSuccess)) ? 'd-none' : ''; ?>"> 
                    <strong>At North East Metal Spinners we are committed to providing you with an excellent customer experience.
                    Our dedicated team will respond to your request as soon as possible.</strong>
                </p>
            </div>
        </div>
        <div class="row">
